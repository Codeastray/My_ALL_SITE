        ...
        <div class="collapse navbar-collapse border-bottom border-primary bg-transparent justify-content-center"
            ...
            <div class="navbar-nav">
                ...
                <NuxtLink @click="hidemenu" to="/tool" class="nav-link h5" data-toggle="tooltip" data-placement="bottom"
                    title="我的技能"> My tools
                    in IT</NuxtLink>
                <NuxtLink @click="hidemenu" to="/certificate" class="nav-link h5" data-toggle="tooltip"
                    data-placement="bottom" title="還會些什麼?">What's
                    more</NuxtLink>
                <li v-show="isNotClick" class="nav-item dropdown h5" data-toggle="tooltip" data-placement="right"
                    title="作品集">
                ...
                <div class="modal-body">
                    <form>
                        <div class="form-group text-left">
                            ...
                            <input type="text" class="form-control" id="login_account" v-model="login_account"
